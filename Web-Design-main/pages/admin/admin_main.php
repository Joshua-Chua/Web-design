...
<div class = "dashboard">
    <div class = "sidebar">
        <a href = "admin_main.php" class = "active">Main Menu</a>
...
fetch('../../system/get_live_data.php')
    .then(response => response.json())
    .then(data => {
        console.log(data); // Add this to see what the server is actually sending
        document.getElementById('live-energy').innerText = data.display_energy;
        document.getElementById('live-carbon').innerText = data.display_carbon;
    })
</script>
