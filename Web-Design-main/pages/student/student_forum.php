...
// Fetch forum posts and join with student table to get the 'name' column
$post_query = "SELECT post.*, student.name 
               FROM post 
...
<div class="topbar">
    ...
    <span class="page-title">Student/My Forum</span>
    ...
    <div class="topbar-left">
        ...
        <span class="breadcrumb">
            ...
            <span class="breadcrumb-separator">/</span>
            <a href="student_forum.php" class="breadcrumb-link">My Forum</a>
        </span>
    </div>
    ...
    <div class="content event-page">
        <div class="Event-header">
            ...
            <div class="header-right">
                <a href="student_create_forum.php" class="btn-add-post">
                    ...
                    <div class="post-header">
                        <span class="author">
                            Posted by: <?php 
                                ...
                                echo !empty($post['name']) ? htmlspecialchars($post['name']) : "Student #".$post['student_id']; 
                            ?>
                        </span>
                    ...
                    <div class="comment-section" style="margin-top: 25px;"> 
                        <div class="existing-comments" style="margin-bottom: 15px;">
                            <?php
                                ...
                                // Fetch comments and join with the student table to get the 'name' column
                                ...
                                if (mysqli_num_rows($comment_res) > 0):
                                    while ($comment = mysqli_fetch_assoc($comment_res)): ?>
                                        <div class="comment-bubble" style="margin-bottom: 10px;">
                                            <strong><?php echo htmlspecialchars($comment['name'] ?? 'Student #'.$comment['user_id']); ?>:</strong> 
                        ...
                        <form action="add_comment.php" method="POST" class="comment-form" style="display: flex; align-items: center; gap: 15px;">
                            <input type="hidden" name="post_id" value="<?php echo $post['post_id']; ?>">
                            <input type="text" name="comment_text" placeholder="Write a comment..." class="comment-input" required style="flex: 1;">
...
<script>
// JavaScript to handle the report popup details
